...
const Section = ({ id, children }) => {
  ...
  return (
    <section id={id} ref={ref} className="section" data-testid={`section-${id}`}>
      {children}
    </section>
  );
};
  ...
  return (
    <section id="home" className="hero" data-testid="hero">
      <div className="hero-frame">
        ...
        <Eyebrow>[ OPEN FOR REGISTRATION ]</Eyebrow>
        <h1 data-testid="hero-headline">AI That Builds India. Not Demos It.</h1>
        <p className="sub">
        ...
        <div className="ticker" data-testid="hero-ticker">
          <span>[ TRACKS: <b>03</b> ]</span><span>·</span>
          <span>[ SECTORS: <b>13</b> ]</span><span>·</span>
          <span>[ PROBLEM STATEMENTS: <b>50+</b> ]</span><span>·</span>
          <span>[ PILOT BUDGET: <b>₹2–3 CR</b> ]</span><span>·</span>
          <span>[ PRIZE POOL: <b>₹30 LAKHS</b> ]</span>
        </div>
      </div>
    </section>
  );
  ...
  return (
    <Section id="opportunity">
      <div className="section-head">
        ...
        <h2>The Gap Between AI That Works and AI That Deploys</h2>
        <p>India has no shortage of AI demos. It has a shortage of AI that survives contact with live government infrastructure. This program closes that gap.</p>
      </div>
      <div className="stat-grid">
        {stats.map((s, i) => (
          <div className="stat-block" key={i} data-testid={`stat-block-${i}`}>
            <span className="stat-num"><span className="bk">[ </span>{s.n}<span className="bk"> ]</span></span>
            <h4>{s.t}</h4>
            <p>{s.d}</p>
          </div>
        ))}
  ...
  return (
    <Section id="program">
      ...
      <div className="track-panel" data-testid="track-panel">
        <span className="track-number-bg">{t.num}</span>
  ...
  return (
    <Section id="problems">
      <div className="section-head">
        ...
        <p>Every statement below maps to an active Rodic mandate. Filter by sector to find your fit.</p>
      </div>
      ...
      <div className="problem-grid" data-testid="problem-grid">
        {visible.map((p, i) => (
          <div className="problem-card" key={`${filter}-${i}`} data-testid="problem-card">
  ...
  return (
    <Section id="prizes">
      <div className="section-head">
        ...
        <h2>Win the Prize. Then Win the Deployment.</h2>
      </div>
      ...
      <div className="judge-grid">
        {[0, 1, 2, 3].map((i) => (
          <div className="judge-card" key={i} data-testid={`judge-card-${i}`}>
            ...
            <span className="ji">Position Title</span>
            <span className="ji">Organisation</span>
          </div>
        ))}
      </div>
    ...
    <Section id="registration">
      <div className="reg-wrap">
        <div className="section-head">
          ...
          <p>Register your interest. We'll send competition details and launch announcements to your email.</p>
        </div>
        <div className="reg-box" id="registrationForm">
          {done ? (
            <div className="success-state" data-testid="reg-success">
              <div className="ok"><span className="bk">[ </span>REGISTRATION RECEIVED<span className="bk"> ]</span></div>
  ...
  return (
    <footer className="footer" data-testid="footer">
      <div className="footer-inner">
        ...
        <div>
          <h5>Connect</h5>
          <p className="ftag">partnerships@rodic.in</p>
      ...
      <div className="footer-bottom">© 2026 Rodic Consultants × NASSCOM AI Foundry. All rights reserved.</div>
    </footer>
  );
}
